...
<head>
    ...
    $(document).ready(function() {
        ...
        $('#save').submit(function(e) {
            ...
            formData.append('num_req', num_req);
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <!-- Add by 04726 on 20260330 -->
                                                            <select class="custom-select" id="rfq_type" name="rfq_type" required> 
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <strong>
                                                            <label class="form-label mb-1">
                                                                <i class="fa fa-file-text-o"></i> Category
                                                            </label>
                                                        </strong>
                                                            ...
                                                            <select class="custom-select" name="pu_code" required>
                                                                ...
                                                                $sql = "
                                                                    SELECT 
                                                                        CateID,
                                                                        EmployeeCode,
                                                                        ISNULL(CateDescription,'') + ' | ' + ISNULL(CateDetail,'') + ' | ' + 
                                                                        ISNULL(Prefix,'') + ISNULL(ThFirstName,'') + ISNULL(ThLastName,'') AS DisplayText
                                                                    FROM Vw_CateMaster
                                                                    WHERE IsDeleted = 0
                                                                    ORDER BY CateID ASC";
                                                                ...
                                                                ?>
                                                                    <option value="<?= $row['CateID'] . '|' . $row['EmployeeCode']; ?>">
                                                                        <?= $no . '. ' . $row['DisplayText']; ?>
                                                                    </option>
                                                                <?php 
                                                                    $no++; 
